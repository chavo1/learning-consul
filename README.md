...
```
#### Additionaly I installed [NGINX](https://www.nginx.com/resources/wiki/) with [envconsul](https://github.com/hashicorp/envconsul), if this not needed you can simply comment the 'call_nginx.sh' and 'envconsul.sh' scripts in Vagrantfile and uncomment 'nginx.sh'. This will populate the 'Welcome to NGINX!' page with API.
